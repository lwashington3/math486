...
\begin{problems}
	...
	\begin{problems}
		...
		\subproblem What is the definition of the kernel $K(A)$ or nullspace $N(A)$? \addanswer{Problem-4c}
	\end{problems}
	\problem Consider $A\vec{x}=\vec{b}$ where
	\[ A = \left[ \begin{array}{rrrr}
		1 & 3 & 1 & 1\\
	...
	\begin{problems}
		...
		\subproblem What is the definition of the kernel $K(A)$ or nullspace $N(A)$? \addanswer{Problem-5c}
	\end{problems}
